...
export default class CreateCategory extends Component {
    ...
    renderItem = ({ item }) => {
        ...
        return (
            ...
            <TouchableOpacity onPress={() => navigate("MarketPlaceCreateSubCategory", { category_id: item.category_id, category_name: item.category_name })}>
                ...
                <View style={{ flex: 1, backgroundColor: '#fff' }}>
                    ...
                    <Row style={{ height: 50, marginHorizontal: 20 }}>
                        <Col style={{ justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ color: "#333", fontSize: 25, fontFamily: "Roboto-Medium", color: "#62BB46" }}>{t("Select Category")}</Text>
                        </Col>
