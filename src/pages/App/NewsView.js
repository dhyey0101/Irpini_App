...
import { news_detailAction } from './../../util/Action';
...
export default class NewsView extends Component {
    ...
    async ViewNews() {
        let news_id = this.props.navigation.getParam("news_id");
        ...
        news_detailAction(viewNewsData, Token).then((responseJson) => {
                    ...
                    <Row style={styles.headerContainer}>
                        <View style={styles.top_background}>
                            <View style={styles.top_content}>
                                <TouchableOpacity style={styles.headerBackArrow} onPress={() => navigate("News")}>
                                    <Col style={{ justifyContent: 'center' }}>
                                        <Back_Arrow width={15} height={15} />
                                    </Col>
                                </TouchableOpacity>
