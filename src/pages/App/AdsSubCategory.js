...
export default class AdsSubCategory extends Component {
    ...
    renderItem = ({ item }) => {
        ...
        return (
            ...
            <TouchableOpacity onPress={() => navigate("MarketPlaceAdsSubCategoryAdvertList", { category_name: item.category_name, sub_category_id: item.sub_category_id, main_category_name: this.state.category_name, category_id:this.state.category_id })}>
