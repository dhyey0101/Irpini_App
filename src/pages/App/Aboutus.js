...
import { chi_siamo_detailsAction } from './../../util/Action';
...
export default class NewsView extends Component {
    ...
    async GetData() {
        ...
        chi_siamo_detailsAction(apiData, Token).then((responseJson) => {
                ...
                <View style={{ flex: 1, backgroundColor: '#fff' }}>
                    {/* <Row style={{ marginTop: -20, height: 120 }}>
                        ...
                        <Row style={styles.slide2Logo}>
                            <TouchableOpacity style={{ alignItems: 'center', padding: 20, width: 60 }} onPress={() => navigate("News")}>
                    ...
                    <Row style={styles.headerContainer}>
                        <View style={styles.top_background}>
                            <View style={styles.top_content}>
                                ...
                                <Text style={styles.headerText}>{t("Who we are")}</Text>
                            </View>
                        </View>
                    </Row>
                    <View style={{justifyContent:'center', alignItems:'center', marginHorizontal: 20, marginBottom:20}}>
                    {/* <Row style={{ height: 50, marginHorizontal: 20, alignItems: 'center', marginTop: 20 }}>
                    ...
                    <ScrollView>
                        ...
                        <Row style={{ marginTop: 30, marginBottom: 30, justifyContent:'center', marginHorizontal:20 }}>
