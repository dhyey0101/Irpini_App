...
import { Dimensions, ActivityIndicator, RefreshControl, FlatList, KeyboardAvoidingView, AsyncStorage, StyleSheet, View, Image, Text, TouchableOpacity, Modal, Platform, Linking } from 'react-native';
                ...
                <View style={{ flex: 1, backgroundColor: '#fff' }}>
                    {/* <Row style={{ marginTop: -20, height: 120 }}>
                        ...
                        <Row style={styles.slide2Logo}>
                            ...
                            <Col style={styles.header}>
                                <Text style={{ color: "#fff", fontSize: 17, fontFamily: 'Roboto-Bold' }}>{t("Green number")}</Text>
                            </Col>
                        </Row>
                    </Row> */}
                    <Row style={styles.headerContainer}>
                        <View style={styles.top_background}>
                            <View style={styles.top_content}>
                                ...
                                <Text style={styles.headerText}>{t("Green number")}</Text>
                            </View>
                        </View>
                    </Row>
                    ...
                    <Row style={{ height: 50, marginHorizontal: 20 }}>
                        <Col style={{ justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ color: "#333", fontSize: 24, fontFamily: "Roboto-Bold", color: "#62BB46" }}>{t("Call us!")}</Text>
                        </Col>
                    ...
                    <Row style={{ marginHorizontal: 20, marginTop: 20, height: 60 }}>
                        <Text style={{ fontSize: 16, fontFamily: "Roboto-Light", color: "#666666" }}>{t("The numbers are active from Monday to Friday from 8:00 to 16:00")}</Text>
                    </Row>
                    <Row style={{marginHorizontal:20, height: 50}}>
                        ...
                        <Col>
                        <TouchableOpacity onPress={() => this.dialCall(840068477)}>
                            <Text style={{ fontSize: 20, fontFamily: "Roboto-Medium", color: "#666666" }}>840 068 477</Text>
                            </TouchableOpacity>
                        </Col>
                    </Row>
                    <Row style={{marginHorizontal:20, height: 50}}>
                    <Col style={{width:40}}>
                        ...
                        <Col>
                        <TouchableOpacity onPress={() => this.dialCall('0825784549')}>
                            <Text style={{ fontSize: 20, fontFamily: "Roboto-Medium", color: "#666666" }}>0825 78 45 49</Text>
                            </TouchableOpacity>
                        </Col>
                    </Row>
                </View>
