    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#fff' }}>
                ...
                <Row style={{ justifyContent: 'center', alignItems: 'center', height: 50 }}>
                    <Text style={{ color: "#62BB46", fontFamily: "Roboto-Bold", fontSize: 24 }}>{t("Select your profile")}</Text>
                </Row>
                <LinearGradient
                ...
                <Col style={{ justifyContent: 'space-around', alignItems: "center" }}>
                    ...
                    <Col style={{ width: "90%" }}>
                        <TouchableOpacity onPress={() => navigate("Registration" , { Role: "person" })}>
                            <LinearGradient colors={['rgba(140,198,63,0.8)', 'rgba(57, 181, 74,0.8)']}
                                ...
                                <Image source={require('./../../images/Personal.png')} style={{ width: 150, height: 150 }} />
                                <Text style={{ fontSize: 20, fontFamily: "Roboto-Regular", color: "#fff", margin: 10 }}>{t("Person")}</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                    </Col>

                    <Col style={{ width: "90%" }}>
                        <TouchableOpacity onPress={() => navigate("Registration" , { Role: "corporate" })}>
                            <LinearGradient colors={['rgba(140,198,63,0.8)', 'rgba(57, 181, 74,0.8)']}
                                style={{ justifyContent: 'center', alignItems: 'center', padding: 15, borderRadius: 40 }}>
                                <Image source={require('./../../images/corporate.png')} style={{ width: 150, height: 150 }} />
                                <Text style={{ fontSize: 20, fontFamily: "Roboto-Regular", color: "#fff", margin: 10 }}>{t("Company")}</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                    </Col>
                </Col>
